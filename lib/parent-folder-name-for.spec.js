...
describe('Helper: parent-folder-name-for', () => {
  it('returns the main migration guide for vue', () => {
    expect(
      getParentFolderName('/Users/fritzc/code/antd-migration-helper/rules/vue/array-prototype-remove.js')
    ).toBe('vue')
  })

  it('returns the main migration guide for vue', () => {
    expect(
      getParentFolderName('C:\\Users\\fuis\\AppData\\Roaming\\npm\\node_modules\\antd-migration-helper\\rules\\vue\\array-prototype-remove.js')
    ).toBe('vue')
  })
})
